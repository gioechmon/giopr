...
1. **ANDROID_HOME**
   ...
   - Si no encuentras el SDK con Windows+R pon `%LOCALAPPDATA%\Android\Sdk`
2. **platform-tools**
   - Nombre: `platform-tools`
   - Valor: ruta a tu platform-tools, por ejemplo: `C:\Users\user\AppData\Local\Android\Sdk\platform-tools`
   - Si no encuentras el platform-tools con Windows+R pon `%LOCALAPPDATA%\Android\Sdk\platform-tools`
